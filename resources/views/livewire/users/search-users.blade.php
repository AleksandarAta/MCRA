<div class="relative mr-3" x-data = "{isOpen: true}" @click.away = 'isOpen = false' @keydown.escape = 'isOpen = false'
...
>   <div class="flex rounded-full border border-orange-400 p-2 dark:border-orange-600">
    ...
    wire:model.live.debounce.300ms="search" placeholder=" {{ __('Search for users') }}" 
    ...
    <div x-show ="isOpen" class="w-56 rounded font-semibold text-sm  text-gray-800 dark:text-gray-200 leading-tight self-center absolute bg-white dark:bg-gray-600 z-10 flex flex-col">
