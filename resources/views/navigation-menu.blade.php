<nav x-data="{ open: false, show: false }"
    class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 h-20 shadow-xl">
                ...
                @if (Route::has('login'))
                    @auth
                        ...
                        <div class="ml-4 p-2 text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <a href="{{ route('lang.change', ['lang' => 'en']) }}" class="dark:text-white">EN</a>
                        </div>
                        <button id="darkToggle" class="ml-4 p-2 text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <svg class="fill-gray-300 w-5 h-6 dark:hidden " id="moon"
                        ...
                        <div class="ms-3 relative ml-4 p-3">
