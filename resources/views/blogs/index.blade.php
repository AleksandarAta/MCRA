        ...
        <div class="w-2/3 mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="grid grid-cols-4 gap-4 p-2">
                        ...
                        <div class="max-w-3xl mx-auto p-6 bg-gray-200 dark:bg-gray-900 rounded-lg shadow-md relative h-96">
                            ...
                            <button class="rounded p-2 absolute bottom-2 right-2 bg-orange-400 hover:text-black hover:bg-white hover:border hover:border-orange-400 ml-3 dark:bg-orange-600 dark:text-white dark:hover:text-black dark:hover:bg-white dark:hover:border-orange-400">
                                {{ __("Show More") }}</button>
                        </div>
    {{-- {{ $collection->links() }} --}}
    @endforeach
